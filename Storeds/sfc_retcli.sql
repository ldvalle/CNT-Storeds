...
RETURNING smallint as codRetorno, char(50) as descRetorno, char(12) orden_ot;
...
DEFINE error_info           CHAR(100);
    ...
    ON EXCEPTION SET sql_err, isam_err, error_info
        RETURN 1, 'sfc_retcli. sqlErr '  || to_char(sql_err) || ' isamErr ' || to_char(isam_err) || ' ' || error_info, null, null;
    END EXCEPTION;
...
GRANT EXECUTE ON sfc_retcli TO
